...
namespace Lanna_s_Defense
{
    ...
    {
        public AnimatedSprite basicTurretTexture1 { get; set; }
        ...
        public Swordman(Vector2 position, List<Enemy> enemies, float turretRange, double gt, int shootRate, AnimatedSprite basicTurretTexture, UpgradeCard shootUppgrade, UpgradeCard rangeUppgrade)
        {
            ...
            this.basicTurretTexture1 = basicTurretTexture;
        ...
        void GetRotation(Enemy target)
        {
            ...
            if (target != null && targetFound)
            {
                ...
                if (gt > animTime + shootRate)
                {
                    if (!e)
                    {
                        ...
                        position = test;
                        basicTurretTexture1 = Game1.changeTurretTexture1(basicTurretTexture1, 0);
            ...
            {
                basicTurretTexture1 = Game1.changeTurretTexture1(basicTurretTexture1, 1);
            }
        }
