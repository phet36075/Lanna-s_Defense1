...
namespace Lanna_s_Defense
{
    ...
    {
        public AnimatedSprite basicTurretTexture2 { get; set; }
        ...
        public Cannon(Vector2 position, List<Enemy> enemies, float turretRange, double gt, int shootRate, AnimatedSprite basicTurretTexture, UpgradeCard shootUppgrade, UpgradeCard rangeUppgrade)
        {
            ...
            this.basicTurretTexture2 = basicTurretTexture;
        ...
        void GetRotation(Enemy target)
        {
            ...
            if (target != null && targetFound)
            {
                ...
                if (gt > animTime + shootRate)
                {
                    if (!e)
                    {
                        ...
                        position = test;
                        basicTurretTexture2 = Game1.changeTurretTexture1(basicTurretTexture2, 0);
            ...
            {
                basicTurretTexture2 = Game1.changeTurretTexture1(basicTurretTexture2, 1);
            }
        }
